...
func main() {
	...
	resp, err = client.Substract(context.Background(), &arifmeticService.Request{A: 1231, B: 345})
	if err != nil {
		fmt.Println(err)
		return
	}
	...
	resp, err = client.Multiply(context.Background(), &arifmeticService.Request{A: 1231, B: 345})
	if err != nil {
		fmt.Println(err)
		return
	}
	...
	resp, err = client.Remainder(context.Background(), &arifmeticService.Request{A: 1231, B: 345})
	if err != nil {
		fmt.Println(err)
		return
	}
